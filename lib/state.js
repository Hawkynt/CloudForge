...
function repairState(wfState, orderedPhaseNames, options = {}) {
  ...
  // Extend iteration budget on resume
  if (typeof options.additionalIterations === 'number' && options.additionalIterations > 0)
    wfState.maxIterations = wfState.iteration + options.additionalIterations;
